...
class QLearner():
    def __init__(self, env:gym.Env, max_steps=2000000, gamma=0.8, alpha=0.1, end_eps=0.01, start_eps=1.0,  eps_decay=0.9999):
        self.env = env
    ...
    def run_policy(self):
        ...
        print(f"Successfull episodes: {n_success}")
        print(f"Reward obtained: {total_rw}")
