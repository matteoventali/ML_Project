...
# ML Project : tabular Q-learning for Blackjack envinronment
...
class QLearner():
    def __init__(self, env:gym.Env, max_steps=10000000, gamma=0.99, alpha=0.1, end_eps=0.01, start_eps=1.0,  eps_decay=0.9999):
        self.env = env
        ...
        self.policy_name = 'policy_blackjack'
